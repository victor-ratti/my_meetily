          ...
          <div className="space-y-4">
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-700 space-y-1 ml-4">
                ...
                <li>- Model provider (e.g., "Local", "Parakeet", "Whisper")</li>
              </ul>
              <p className="text-xs text-gray-500 mt-2 italic">Helps us understand which transcription models users prefer</p>
            </div>
